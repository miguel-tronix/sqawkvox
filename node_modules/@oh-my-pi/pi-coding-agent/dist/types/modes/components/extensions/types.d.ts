 ...
 */
export declare function makeExtensionId(kind: ExtensionKind, name: string): string;
/**
 * Parse extension ID into kind and name.
 */
export declare function parseExtensionId(id: string): {
    kind: ExtensionKind;
    name: string;
} | null;
/**
 ...
 */
export declare function sourceFromMeta(meta: SourceMeta): Extension["source"];
