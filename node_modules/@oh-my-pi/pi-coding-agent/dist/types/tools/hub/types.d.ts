...
import type { IrcDeliveryReceipt, IrcMessage } from "../../irc/bus.js";
import type { LaunchParams, LaunchToolDetails } from "./launch.js";
/**
 ...
 */
export type HubOp = "send" | "wait" | "inbox" | "list" | "jobs" | "cancel" | "start" | "ps" | "logs" | "stop" | "restart" | "describe";
...
export declare function hubErrorResult(text: string, details: CoordinationDetails): AgentToolResult<HubDetails>;
